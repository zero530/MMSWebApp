...
{
    public class SMEMatricesController : Controller
    {
        ...
        // GET: SMEMatrices/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: SMEMatrices/Create
